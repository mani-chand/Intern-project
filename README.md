Hello sir/madam,This project given given by you is to build a item cart pages where we can chekout with needed items by giving address while checkout.At frist what i 
